<template>
  <div>
    ...
    <div v-else class="space-y-4">
      <RequestCard 
        v-for="request in getRequestsByStatus('Rejected')" 
        :key="request._id" 
        :request="request"
        :actionButtons="[
          {
            name: 'approve',
            text: 'Approve',
            class: 'bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-md text-sm transition duration-150',
