    ...
    <div class="max-w-md w-full mx-auto">
      <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 p-6 text-center">
          ...
          <p class="text-blue-100 mt-1">Start Your Return or Exchange</p>
        </div>
        
        <div class="p-8">
          <div class="text-center mb-8">
            <div class="mx-auto bg-blue-100 rounded-full p-3 w-16 h-16 flex items-center justify-center">
              <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path>
              </svg>
            </div>
            <p class="text-gray-600 mt-4">Enter your order details to begin the return or exchange process.</p>
          </div>
          
          <form @submit.prevent="findOrder">
            <div class="mb-6">
              <label for="orderNumber" class="block text-gray-700 text-sm font-semibold mb-2">Order Number</label>
              <div class="relative">
                ...
                <input
                  ...
                  id="orderNumber"
                  v-model="orderNumber"
                  class="pl-10 shadow-sm border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
            ...
            <div class="flex items-center justify-center">
              <button
                type="submit"
                :disabled="isLoading"
                class="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
